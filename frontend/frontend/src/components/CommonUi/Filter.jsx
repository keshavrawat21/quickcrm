  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {filteredFromSelected.map((item) => {
        ...
        return (
          <div key={item.key} className="flex filterTag  pr-2">
            <div
              className={cn(
            ...
            <button
              className="flex items-center justify-center p-1 hover:bg-gray-200 rounded-r-md rounded-l-none transition-colors bg-gray-200"
              onClick={() => {
      ...
      {filteredFromUnSelected.length > 0 && (
        <div className="filterTag  float-left min-w-[95px] max-w-[170px] ">
          <Select
            placeholder={
